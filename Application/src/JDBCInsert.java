...
public class JDBCInsert {
    ...
    public void registrerAØvelseGruppeRelasjon(int øgid, int øid) {
        try {
            Class.forName("com.mysql.cj.jdbc.Driver");
            Connection conn = DriverManager.getConnection(url, u, pw);

            PreparedStatement stmt = conn.prepareStatement("insert into ApparatDelAvGruppe(ØvelsesGruppeID, ApparatØvelseID) values (?,?)", Statement.RETURN_GENERATED_KEYS);
    ...
    public void registrerKØvelseGruppeRelasjon(int øgid, int øid) {
        try {
            Class.forName("com.mysql.cj.jdbc.Driver");
            Connection conn = DriverManager.getConnection(url, u, pw);

            PreparedStatement stmt = conn.prepareStatement("insert into KroppsDelAvGruppe(ØvelsesGruppeID, KroppsØvelseID) values (?,?)", Statement.RETURN_GENERATED_KEYS);

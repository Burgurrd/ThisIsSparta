...
//        String t = _Økter.getSelectionModel().getSelectedItem().toString();
//        _ØktBeskrivelse.setText(t);
//    }
//
//
//
...
//    this.ValgtØvelse = VelgØvelse.getSelectionModel().getSelectedItem();//Øvelse med øvelsesnavn: VelgØvelse.getValue();
...
//        }
//        Øvelse t_øvelse = DBController.registrerØvelse(_øvelse); //her kalles registreringsmetode som returnerer øvelseobjekt
//        _øvelse = "";
//        _ØvelseNavn.clear();
...
//        MineApparater.getItems().add(a);
//    }
//
//    @FXML
//    public void displayActiveApparat(){//Viser beskrivelse av apparat via apparatets tostring metode
//        String a = MineApparater.getSelectionModel().getSelectedItem().toString();
//        ApparatBeskrivelse.setText(a);
//    }
//
//    @FXML
...
//        Apparat t_apparat = DBController.registrerApparat(_apparat);//her kalles registreringsmetode som returnerer apparatobjekt
//        ApparatNavn.clear();
//        Funksjon.clear();
...
//        Øvelse ø = _Øvelsesgrupper.getSelectionModel().getSelectedItem();
//
//        _Øvelsesgrupper.getSelectionModel().getSelectedItem().;
//    }
//
//    @FXML
//    public void displayActiveGruppe(){//Viser beskrivelse av gruppe via gruppens tostring metode
//        String g = _Øvelsesgrupper.getSelectionModel().getSelectedItem().toString();
//        GruppeBeskrivelse.setText(g);
//    }
//
//    @FXML
//    public void makeGroup(){//oppretter gruppe med navn og oppdaterer tabell
//        ØvelsesGruppe t_gruppe = DBController.registrerGruppe(GruppeNavn.getText());//her kalles registreringsmetode som returnerer gruppeobjekt
